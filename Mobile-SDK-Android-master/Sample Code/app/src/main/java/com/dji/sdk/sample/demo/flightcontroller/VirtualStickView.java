    ...
    private void setUpListeners() {
        ...
        screenJoystickLeft.setJoystickListener(new OnScreenJoystickListener() {
            ...
            public void onTouch(OnScreenJoystick joystick, float pX, float pY) {
                ...
                pitch = (float) (pitchJoyControlMaxSpeed * dpitch);

                roll = (float) (rollJoyControlMaxSpeed * droll);
        ...
        screenJoystickRight.setJoystickListener(new OnScreenJoystickListener() {
            ...
            public void onTouch(OnScreenJoystick joystick, float pX, float pY) {
                ...
                yaw = yawJoyControlMaxSpeed * (float)dyaw;
                throttle = verticalJoyControlMaxSpeed * (float)dthrottle;
